...
module.exports = {
    entry: {
        ...
        skills_tree: path.resolve(__dirname, './src/skills_tree.js'), // Add skills_tree.html to the entry
        ...
        game_screen: path.resolve(__dirname, './src/game_screen.js'), // Add game_screen.html to the entry
        login_screen: path.resolve(__dirname, './src/login_screen.js'), // Add login_screen.html to the entry
    },
